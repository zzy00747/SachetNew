...
import 'package:sachet/model/get_web_data/process_data/generate_exam_time_data.dart';
import 'package:sachet/model/get_web_data/process_data/get_exam_time_semesters.dart';
...
Future<List> getExamTimeDataFromWeb(
  ...
  Map jsonData;
  if (semester == null) {
    List semestersData = await getExamTimeSemestersData();
    String semester = semestersData[0];
    jsonData = await generateExamTimeData(semester);
  } else {
    jsonData = await generateExamTimeData(semester);
  }
