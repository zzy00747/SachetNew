...
/// 从 Html 解析 课程表当前学年，可选学年和当前学期
///
/// 返回 (String 当前学年(如 "2025"), Map<学年标签: 对应的值>, String 当前学期(如 "3"=>第一学期，"12"=>第二学期)))
(String?, Map<String, String>, String?) parseClassScheduleSemestersFromHtmlZF(
    String html) {
  ...
  for (int i = 0; i < listLengthXnm; i++) {
    ...
    if (semesterYearLabel != '' &&
        semesterYearValue != '' &&
        semesterYearValue != null) {
  ...
  if (elementXqm != null) {
    if (elementXqm.children.isNotEmpty) {
      ...
      for (int i = 0; i < listLengthXqm; i++) {
        ...
        // semestersIndexes 是固定的，不需要再解析
        // if (semesterIndexLabel != '' &&
        //     semesterIndexValue != '' &&
        //     semesterIndexValue != null) {
  ...
  return (currentSemesterYear, semestersYears, currentSemesterIndex);
}
