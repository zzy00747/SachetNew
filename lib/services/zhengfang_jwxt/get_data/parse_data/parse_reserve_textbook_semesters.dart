...
/// 从 Html 解析 教材预订页面可选学年，当前学年和当前学期
///
/// 返回 (Map<学年标签: 对应的值>, String 当前学年(如 "2025"),  String 当前学期(如 "3"=>第一学期，"12"=>第二学期)))
({
  Map<String, String> semestersYears,
  String? currentSemesterYear,
  String? currentSemesterIndex
}) parseReserveTextbookSemestersFromHtmlZF(String html) {
  final document = parse(html);

  // *****获取当前学年和可选学年列表*****
  final elementXnm = document.getElementById('xnm_cx');
  if (elementXnm == null) {
    throw '找不到学年元素';
  }
  ...
  // *****获取当前学期*****
  String? currentSemesterIndex;
  final elementXqm = document.getElementById('xqm_cx');
  if (elementXqm != null) {
